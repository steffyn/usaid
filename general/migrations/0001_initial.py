# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-10-31 16:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activo', models.BooleanField(default=True)),
                ('coordinador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='usuario_coordinador', to=settings.AUTH_USER_MODEL)),
                ('establecimiento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='general.Establecimientos')),
                ('usuario_sistema', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='usuario_sistema', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='RPN',
